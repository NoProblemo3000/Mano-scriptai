...
// === Projekto kontekstas ===
// Naudotojų ir grupių teisių suteikimas
...
static std::string scenario_demo(HttpClient& http, const std::string& token){
    ...
    const std::string path = "/api/demo/09"; // pritaikykite realiam endpoint’ui
...
int main(int argc, char** argv){
    ...
    LOG_INFO("Startuojame: 09-ServiceNow-User-Provisioning");
    Timer total("total");
