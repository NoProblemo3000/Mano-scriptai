...
// === Projekto kontekstas ===
// CMDB importas iš konfigūracijų inventoriaus
...
static std::string scenario_demo(HttpClient& http, const std::string& token){
    ...
    const std::string path = "/api/demo/03"; // pritaikykite realiam endpoint’ui
...
int main(int argc, char** argv){
    ...
    LOG_INFO("Startuojame: 03-ServiceNow-CMDB-Importer");
    Timer total("total");
