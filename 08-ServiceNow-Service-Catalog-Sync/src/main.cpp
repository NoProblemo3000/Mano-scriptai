...
// === Projekto kontekstas ===
// Paslaugų katalogo sinchronizacija su portalu
...
static std::string scenario_demo(HttpClient& http, const std::string& token){
    ...
    const std::string path = "/api/demo/08"; // pritaikykite realiam endpoint’ui
...
int main(int argc, char** argv){
    ...
    LOG_INFO("Startuojame: 08-ServiceNow-Service-Catalog-Sync");
    Timer total("total");
