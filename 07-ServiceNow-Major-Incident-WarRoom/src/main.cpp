...
// === Projekto kontekstas ===
// Major incident „war room“ kūrimas ir koordinacija
...
static std::string scenario_demo(HttpClient& http, const std::string& token){
    ...
    const std::string path = "/api/demo/07"; // pritaikykite realiam endpoint’ui
...
int main(int argc, char** argv){
    ...
    LOG_INFO("Startuojame: 07-ServiceNow-Major-Incident-WarRoom");
    Timer total("total");
