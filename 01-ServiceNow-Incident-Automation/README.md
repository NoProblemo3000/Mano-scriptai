...
# 01-ServiceNow-Incident-Automation

**Aprašymas:** Automatinis incidentų kūrimas ir atnaujinimas pagal observability įvykius
...
cmake -S . -B build
cmake --build build -j
./build/01-ServiceNow-Incident-Automation
```
