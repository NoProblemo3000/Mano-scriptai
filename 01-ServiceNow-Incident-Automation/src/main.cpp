...
// === Projekto kontekstas ===
// Automatinis incidentų kūrimas ir atnaujinimas pagal observability įvykius
...
static std::string scenario_demo(HttpClient& http, const std::string& token){
    ...
    const std::string path = "/api/demo/01"; // pritaikykite realiam endpoint’ui
...
int main(int argc, char** argv){
    ...
    LOG_INFO("Startuojame: 01-ServiceNow-Incident-Automation");
    Timer total("total");
