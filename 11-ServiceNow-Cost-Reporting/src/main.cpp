...
// === Projekto kontekstas ===
// Paslaugų kaštų ir sunaudojimo ataskaitos
...
static std::string scenario_demo(HttpClient& http, const std::string& token){
    ...
    const std::string path = "/api/demo/11"; // pritaikykite realiam endpoint’ui
...
int main(int argc, char** argv){
    ...
    LOG_INFO("Startuojame: 11-ServiceNow-Cost-Reporting");
    Timer total("total");
