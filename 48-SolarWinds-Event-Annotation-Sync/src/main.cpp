...
// === Projekto kontekstas ===
// Įvykių anotacijų sinchronizacija
...
static std::string scenario_demo(HttpClient& http, const std::string& token){
    ...
    const std::string path = "/api/demo/48"; // pritaikykite realiam endpoint’ui
...
int main(int argc, char** argv){
    ...
    LOG_INFO("Startuojame: 48-SolarWinds-Event-Annotation-Sync");
    Timer total("total");
