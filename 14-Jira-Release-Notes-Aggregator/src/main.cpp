...
// === Projekto kontekstas ===
// Release notes agregatorius iš Git/CI
...
static std::string scenario_demo(HttpClient& http, const std::string& token){
    ...
    const std::string path = "/api/demo/14"; // pritaikykite realiam endpoint’ui
...
int main(int argc, char** argv){
    ...
    LOG_INFO("Startuojame: 14-Jira-Release-Notes-Aggregator");
    Timer total("total");
